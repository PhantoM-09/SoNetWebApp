    ...
    axios.get('https://localhost:7132/api/user/get-user/', { withCredentials: true })
      .then(response => {
        ...
        axios.get('https://localhost:7132/api/file/get-profile-image/', { withCredentials: true })
          .then(imageResponse => {
            setUser({ ...user, lastName: userInfo.lastName, name: userInfo.name, sex: userInfo.sex, birthDate: userInfo.birthDate, friendsCount: userInfo.friendCount, subscriberCount: userInfo.subscriberCount, profileImage: 'https://localhost:7132/' + imageResponse.data.profileImage, profileBackground: 'https://localhost:7132/' + imageResponse.data.profileBackground });
          })
      })
      .catch(error => {
        if (error.response) {
  ...
  return (
    <div className="col-md-10">
      <div className="col-md-12" style={{ position: 'relative' }}>
        ...
        <img className="col-md-12" style={{ height: 370, objectFit: 'cover', borderRadius: 8, zIndex: -1000, position: 'absolute' }} src={user.profileBackground} />
